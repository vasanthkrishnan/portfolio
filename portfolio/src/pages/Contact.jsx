...
import { Linkedin, User, Phone, Mail } from 'lucide-react'
    ...
    <>
      <div className="h-screen w-screen flex justify-center items-center">
            <div className="h-[60%] w-[45%] flex justify-center items-center bg-[#d1f2eb] rounded-md shadow-md">
              <form className='h-[90%] w-[95%] flex flex-row'>
                ...
                <div className='h-full w-3/5 bg-[#343434] flex flow-row justify-center items-center rounded-md shadow-md'>
                    <div className='h-[70%] w-[80%]'>
                      <input type="text" className='text-gray-400 w-full h-[20%] border-[#f8f8f8] border-b p-3 text-xl focus:outline-none bg-[#343434] focus:placeholder-transparent' placeholder='name' id="" />
                      <input type="text" className='text-gray-400 w-full h-[20%] border-[#f8f8f8] border-b p-3 text-xl focus:outline-none bg-[#343434] focus:placeholder-transparent' placeholder='email' id="" />
                      <input type="text" className='text-gray-400 w-full h-[20%] border-[#f8f8f8] border-b p-3 text-xl focus:outline-none bg-[#343434] focus:placeholder-transparent' placeholder='phone' id="" />
                      <textarea className=' resize-none text-gray-400 w-full h-[20%] border-[#f8f8f8] border-b p-3 text-xl focus:outline-none bg-[#343434] focus:placeholder-transparent' placeholder='message' id=""></textarea>
                      <div className=' h-[20%] w-full flex justify-center items-center'>
                        <button className=' h-full w-full bg-[#efebeb] mt-[4rem] font-bold text-2xl rounded-md hover:cursor-pointer hover:bg-[#f8f8f8] hover:text-[#000000] hover:text-3xl'>Send</button>
                      </div>
                    </div>
                </div>
              </form>
